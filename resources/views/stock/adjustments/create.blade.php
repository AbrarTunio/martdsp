<x-app-layout :title="__('Correct stock')">
    <x-flash />

    <x-page-header :title="__('Correct stock')"
                   :description="__('For the things the till cannot know: what you started with, what broke, and what a recount found.')" />

    <form method="POST" action="{{ route('stock.adjustments.store') }}" class="mt-5">
        @csrf
